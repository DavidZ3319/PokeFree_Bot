...
module.exports = {
   ...
   execute: async (client, message, args, prefix, guild, color, channel) => {
        let embed = new MessageEmbed()
            ...
            .setDescription(`PokeFree is the best discord bot to enjoy pokemon in your servers.
...
**HELP PAGES**
> Page 1 : What you'll need to know to start using PokeFree
...
> Page 5 : Help configuring PokeFree in your server.
...
${prefix}redirect reset : Reset redirect channel`)
        ...
        let embed6 = new MessageEmbed()
          ...
          .setDescription(`If you need more information about a specific command, type \`${prefix}help <command>\`.
${prefix}support : https://discord.gg/zT7cccxSR2
